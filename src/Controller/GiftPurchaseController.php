...
'conditions' => ['PurchaseItem.status'=>'0'],
        'limit' => 10,
 ...
 //$purchaseitem = $this->PurchaseItem->find('all',array('limit'=>'10'))->where(['status'=>'0'])->hydrate(false)->toArray();
   $purchaseitem=$this->paginate('PurchaseItem',array('PurchaseItem.status'=>'0','limit'=>'10'));            
	$arr = array();
        ...
        //  $results = $this->paginate('PurchaseItem')->toArray();
          // $this->set('result',$arr); 
             ...
             $purchaseitem = $this->PurchaseItem->find('all',array('limit'=>'10'))->where(['status'=>'1'])->hydrate(false)->toArray();
 ...
 $item = $this->Items->find('all')
        ...
        //   $result = $this->paginate('PurchaseItem',array('conditions'=>array('PurchaseItem.status'=>'0'),'limit'=>10))->toArray();
