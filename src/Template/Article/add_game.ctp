...
<div id="wrapper">
 ...
 <?= $this->Flash->render();?>
                    <h1 class="page-header"><i class="fa fa-user"></i> 添加文章</h1>
                 ...
                 <div class="col-lg-12">
                   ...
                   <form enctype="multipart/form-data" action="<?php echo HTTP_ROOT ?>article/addGame" method="post" id="sign-up_area" role="form"  >
                    ...
                    <div class="form-group">
                      <label for="title">投稿標題</label>
                      <input name="title" type="text" class="form-control" id="title">
                    </div>
                  <div class="form-group" id="descEditor">
                      <label for="from">內容</label>
                      <textarea name="editor1"></textarea>
                    </div>
                      <div class="form-group">
                      <label for="game_type">遊戲類別</label>
                      <input type="text" value="article" name="game_type" class="form-control" id="game_type" readonly="true">
                    </div>
					<div class="form-group">
                      <label for="pwd">分數:</label>
                      <input name="host_score" type="text" class="form-control" id="host_score">
                    </div>
    <div class="form-group">
              ...
              //   },
                ...
                messages:
                {
					...
					"score":
					{
						...
						accept: "Please enter a score only numeric.",
					},
                    "password":
                    {
