...
$starttimeend = date("H:i:s", strtotime($originalDateend));
 ...
 <?= $this->Flash->render();?>
                    <h1 class="page-header"><i class="fa fa-user"></i> 編輯家刊投稿</h1>
                 ...
                 <div class="col-lg-12">
                   ...
                   <form enctype="multipart/form-data" action="<?php echo HTTP_ROOT.'article/editGame/'.$data['id'] ?>" method="post" id="sign-up_area"  role="form">
                    ...
                    <div class="form-group">
                      ...
                      <input name="game_type" type="text" value="article" class="form-control" readonly="true">
                    </div>
<div class="form-group">
                      <label for="pwd">分數:</label>
                      <input name="host_score" type="text" class="form-control" id="host_score" value="<?= $data['host_score']; ?>">
                    </div>
                    <div class="form-group">
