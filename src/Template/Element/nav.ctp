 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
			 ...
			 <li>
                            <?=$this->Html->link(
                                '<i class="fa fa-pencil-square-o"></i> 編輯檔案',
                                    [
                                        'controller'=>'users',
                                        'action'=>'editAdmin'
		...
		<ul class="nav navbar-nav side-nav">
                ...
                <li <?php if(($this->request->params['controller']=="Items") || ($this->request->params['controller']=="Score") ){?>class="active" <?php }?>>
                    <a href="#" id="btn-1" data-toggle="collapse" data-target="#submenu1" aria-expanded="false">
                        <i class="fa fa-gift"></i>
                        禮品 <i class="fa fa-plus" style="float:right";></i></a>
			<ul class="nav collapse" id="submenu1" role="menu" aria-labelledby="btn-1"  style="padding-left:20px;">
				<li <?php if($this->request->params['controller']=="Items" ){?>class="active" <?php }?>>   <?=$this->Html->link(
                                '<i class="fa fa-gift"></i>
                                禮品',
                                    [
                                        'controller'=>'Items',
				...
				<li <?php if($this->request->params['controller']=="score" ){?>class="active" <?php }?>> <?=$this->Html->link(
                                '<i class="fa fa-dot-circle-o"></i>
                                分數範圍
',
                                    [
                                    ...
                                    [
										...
										<li <?php if($this->request->params['controller']=="GiftPurchase" ){?>class="active" <?php }?>> <?=$this->Html->link(
                                '<i class="fa fa-dot-circle-o"></i>
                                禮品換領狀態',
                                    [
                                        'controller'=>'GiftPurchase',
                                        'action'=>'index'
