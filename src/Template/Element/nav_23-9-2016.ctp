 <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		...
		<ul class="nav navbar-nav side-nav">
                ...
                <li <?php if(($this->request->params['controller']=="Items") || ($this->request->params['controller']=="Score") ){?>class="active" <?php }?>><a href="#" id="btn-1" data-toggle="collapse" data-target="#submenu1" aria-expanded="false"><i class="fa fa-gift"></i>Gifts</a>
