                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading heading_label">
                            ...
                            <span class="semi-bold"> 編輯禮品詳細信息</span>
                        ...
                        <div class="panel-body spacing">
                            <div class="row spacing">
                                ...
                                <?= $this->Form->create($item, array('id'=>'editForm','enctype'=>'multipart/form-data')) ?>
                                        
                                        <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">項目名稱</label>
                                            <input type="text" placeholder="Enter Name" value="<?= $item->item_title; ?>" class="form-control col-lg-10" name="item_title">
                                        </div>       
                                        <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">所需分數</label>
                                            <input type="text" placeholder="Enter Score" value="<?= $item->score; ?>" class="form-control col-lg-10" name="score">
                                        </div>
                                        <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">禮品庫存</label>
                                            <input type="text" placeholder="Enter Stock" value="<?= $item->stock; ?>" class="form-control col-lg-10" name="stock">
                                        </div>
                                        <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">描述</label>
                                            <textarea type="text" placeholder="Enter description" class="form-control col-lg-10" name="description"><?= $item->description; ?></textarea>
                                            </div>
 <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">換領方法</label>
                                            <textarea type="text" placeholder="Enter redemmption" class="form-control col-lg-10" name="method_redemmption"><?= $item->method_redemmption; ?></textarea>
                                            </div>
                                                 <div class="form-group form_row">
                                            <label class="col-lg-2 form_lable">條款</label>
                                            <textarea type="text" placeholder="Enter term & conditions" class="form-control col-lg-10" name="terms_conditions"><?= $item->terms_conditions; ?></textarea>
                                            </div>
                                    ...
                                    <input type="hidden" name="image1" value="<?php echo $item->image; ?>">
