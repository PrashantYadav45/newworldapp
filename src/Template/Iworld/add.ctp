 ...
 <?= $this->Flash->render();?>
                    <h1 class="page-header"><i class="fa fa-user"></i> 加 I-World 遊戲</h1>
            ...
            <div class="row spacing">
                 <div class="col-lg-12">
                   ...
                   <form onsubmit="return atleast_onecheckbox(event)" action="<?php echo HTTP_ROOT ?>iworld/add" method="post" id="sign-up_area"  enctype="multipart/form-data" role="form">
