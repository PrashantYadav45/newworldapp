       ...
       <div id="page-wrapper" style="min-height: 343px;">
            <div class="row spacing">
                <div class="col-lg-12 main_heading">
                    <?= $this->Flash->render();?>
                    <h1 class="page-header"><i class="fa fa-search-plus"></i>I-world 遊戲</h1>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="row spacing">
                                ...
                                <div class="col-md-7 right">
                                    ...
                                    <div class="btn btn-default btn-danger"><a href="<?php echo HTTP_ROOT ?>Iworld/add" >加入i-world 遊戲</a>
                                </div>
                            </div>
...
<!--                                             <th class="col-xs-3"><?= $this//->Paginator->sort('terms') ?></th>
 -->                                            <th class="actions"><?= __('操作') ?></th>
                                        ...
                                        if(!empty($iworld)){
                                        foreach ($iworld as $iworld): ?>
                                        <tr> 
                                            <td><?= h($iworld->title) ?></td>
                                            <td><?= h($iworld->game_type) ?></td>
                                           <td class="actions">

                                <?= $this->Html->link(
                                 $this->Html->tag('span', '', array('class' => 'glyphicon glyphicon-edit')),
                                array('action'=>'edit', $iworld->id), array('class' => 'btn btn-info btn-xs', 'target' => '_self','escape' => false, 'rel'=>'tooltip', 'data-placement'=>'top', 'title'=>'Edit'))?>               
                                
                                      <?= $this->Form->postLink('<i class="glyphicon glyphicon-trash"></i> ',
                                        ['action' => 'delete', $iworld->id], 
                                        [
                                            'escape' => false,
